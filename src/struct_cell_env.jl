...
# In ShapeGrowthModels.jl (or your struct_cell_env.jl file)
...
mutable struct CellModel{Dim}
    ...
    history::Vector{NamedTuple{
        (:cells, :stromal_cells),
        Tuple{Dict{NTuple{Dim, Int64}, Cell{Dim}}, Dict{NTuple{Dim, Int64}, ShapeGrowthModels.StromalCell{Dim}}}
    }}   
...
@with_kw mutable struct ExtraCellularMatrix{Dim}
    ...
    stromal_cells::Dict{NTuple{Dim, Int64}, ShapeGrowthModels.StromalCell{Dim}} = Dict{NTuple{Dim, Int64}, ShapeGrowthModels.StromalCell{Dim}}()
